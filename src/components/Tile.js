function Tile({x, y, blockSize=1, active, setActive, id, children}) {
    ...
    return <div
                ...
                style={!act ? 
                    { top: top+'px', left: left+'px', height: height+'px', width: width+'px', fontSize: height+'px'}
                    :
                    { top: (fromTop-10)+'px', left: (fromLeft-50)+'px', height: (maxHeight+20)+'px', width: (maxWidth+100)+'px', fontSize: maxHeight+'px' }
                }
            >
                <div style={{ 
